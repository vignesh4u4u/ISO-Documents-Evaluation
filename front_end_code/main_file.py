...
if files:
    ...
    for file in files:
        ...
        if ats_score >= 60:
            ...
            if file.name not in st.session_state['checkbox_state']:
                st.session_state['checkbox_state'][file.name] = False
            checkbox = st.checkbox(checkbox_label, value=st.session_state['checkbox_state'][file.name], key=file.name)
            st.session_state['checkbox_state'][file.name] = checkbox
